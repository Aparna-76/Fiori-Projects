		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Myfirstfioriwork",
									"targetURL": "#comapplexusfioriworks-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexusfioriworks-display": {
								"semanticObject": "comapplexusfioriworks",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.fioriworks",
									"url": sap.ui.require.toUrl("com/applexus/fioriworks")
								}
							}
						}
					}
