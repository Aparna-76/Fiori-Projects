		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "calculator",
									"targetURL": "#comapplexusfioritask-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexusfioritask-display": {
								"semanticObject": "comapplexusfioritask",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.fioritask",
									"url": sap.ui.require.toUrl("com/applexus/fioritask")
								}
							}
						}
					}
